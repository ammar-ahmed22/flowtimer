...
const TaskItem: React.FC<TaskItemProps> = ({
  ...
  return (
    <Flex pos="relative" align="center" onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)}  {...others}>
      <Checkbox
      ...
      >
        ...
        <EditableInput 
          borderRadius="none"
          _focusVisible={{ boxShadow: "none", borderBottom: "solid 1px", borderColor: "brandGray.400" }}
          maxW={`calc(${contSm} - ${checkBoxSize} - ${space2} - (${space6} * 2))`}
          _placeholder={{
