...
const WorkDisplay: React.FC = () => {
  ...
  return (
    <VStack mt="15vh" textAlign="center" justify="center" align="center" spacing={10} >
      <Tasks />
      ...
      <Text 
        mb="16"
      >Your current break time is: <Text as="span" color="brandPurple.700" fontWeight="bold" fontFamily="mono" fontSize="xl">{zeroPad(mins)}:{zeroPad(secs)}</Text></Text>
      <Controls 
        isStarted={isStarted}
