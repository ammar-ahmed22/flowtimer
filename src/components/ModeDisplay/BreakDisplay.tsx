...
const BreakDisplay: React.FC = () => {
  const { timeWorked, breakRatio, toggleMode, setTimeWorked, timer } = useContext(Context);
  ...
  return (
    <VStack textAlign="center" mt="15vh" align="center" justify="center" spacing={10} maxH="100vh" >
      <Tasks />
