        ...
        <ModalBody>
          <Section heading="Timer" icon={FaRegClock} >
            <Input 
              ...
              info={{
                title: "Break Ratio",
                description: ["The break ratio is how your break time is calculated. The amount of time you work is multiplied by the value set for the break ratio to get your calculated break time. By default, it is set to 0.2 (1/5).", "For example, if the break ratio is set to 0.2 (1/5), working for 25 minutes would result in a 5 minute break. Working for 60 minutes would result in a 12 minute break."]
              }}
            />
            <Input 
              ...
              info={{
                ...
                description: ["The minimum break time can be set to force yourself to work for a set amount of time before taking a break.", "You will only be allowed to take a break once your calculated break time hits this set value. By default it is set to 1 minute."]
              }}
            />
          </Section>
          <Section
